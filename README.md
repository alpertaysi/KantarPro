...
4. `database/004_add_fatura_id.sql` ve `database/005_add_muaf_kolonlari.sql` dosyalarini calistirin. Fresh install sonrasi idempotent olarak tekrar calissalar da sorun olmamalidir.
...
2. Scriptleri sirasiyla calistirin: `000_create_migration_history.sql`, `002_add_saha_ziyareti_kantar_dosyasi.sql`, `004_add_fatura_id.sql`, `005_add_muaf_kolonlari.sql`.
